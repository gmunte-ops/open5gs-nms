...
import { Open5gsApiClient, parsePeerIP } from '../../application/use-cases/open5gs-api-client';

import { ActiveUE, UeApnSession, ILegacySessions } from '../../domain/contracts/legacy-sessions';
export class LocalLegacySessions implements ILegacySessions {
